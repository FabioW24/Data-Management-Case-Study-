...
VALUES (6,256090.00,'people'),
       ...
       (9,8374834,'Player'),
       (9,0.94,'percent'),
       (10,373878,'Assembly instructions'),
       (10,0.11,'Percent'),
       (10,0.89,'Percent');
...
VALUES (8,31,6,'2026-02-15',254090.00),
       (1,34,7,'2026-06-02',0.45),
       (7,43,10,'2026-04-10',273879),
       (2,37,8,'2025-10-24',0.48);


INSERT INTO extracted_values(job_id,value,unit)
VALUES (8,2.22,'kilogramms');

INSERT INTO review_actions(user_id,value_number,job_id,review_date,changed_value)
VALUES (1,35,7,'2026-03-12',78);
